...
try:
    ...
    import py2exe, pygame, random, sys
...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = os.path.join("src", "space invaders.py")
 
        #Name of program
        self.project_name = "Space Invaders"
 
        #Project url
        self.project_url = "tomengine.ru"
 
        #Version of program
        self.project_version = "1.0"
 
        #License of the program
        self.license = "LGPL License"
 
        #Auhor of program
        self.author_name = "Evgenij"
        self.author_email = "gpont97@gmail.com"
        self.copyright = "Copyright (c) 2014 Evgenij Guzhikhin."
 
        #Description
        self.project_description = "Space Invaders"
